...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/tablePopulation.js":[function(require,module,exports) {
"use strict";
...
input.addEventListener("keyup", function (event) {
  ...
  if (event.keyCode === 13) {
    ...
    var inputValue = input.value; // validation: check if proper a tag is present in input

    var inputAsHTMLel = new DOMParser().parseFromString(inputValue, "text/xml");
    ...
    var getALink = inputAsHTMLel.getElementsByTagName("a")[0];
    ...
    (0, _axios.default)({
      ...
      var linkIsFake = res.data.linkIsFake;
...
var tableRows = document.getElementsByClassName("tableData")[0];
...
var tableRowsGenerated = ""; // populate table

var animationDelay = 1000;
tableData.forEach(function (element) {
  var tds = ""; // generate linkData

  element["linkData"] = "<!--  &lt; for > to display html code (instead of rendering it by browser) -->\n      &lt;a href=\"".concat(element.actualLink, "\"> ").concat(element.displayLink, " &lt;/a>");

  for (var data in element) {
    var tdData = element[data]; // if (data === "linkData") {
    //   tdData = `<!--  &lt; for > to display html code (instead of rendering it by browser) -->
    //   &lt;a href="${element.actualLink}"> ${element.displayLink} &lt;/a>`;
    // }

    tds += "<td class='".concat(data, "'>").concat(tdData, "</td>");
  }
  ...
  tableRowsGenerated += "<tr style='animation-delay:".concat(animationDelay, "ms' class=").concat(classAdded, ">").concat(tds, "</tr>");
  animationDelay += 250;
});
tableRows.outerHTML = tableRowsGenerated; // tableRows.outerHTML = `<tr>
// <td>
...
// <td>Yes</td>
// </tr>`
},{"./styles.css":"src/styles.css","axios":"node_modules/axios/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/tablePopulation.js"], null)
//# sourceMappingURL=/tablePopulation.84558414.js.map